...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "Equipes", icon: Users, path: "/teams" },
    { name: "Deploys", icon: Rocket, path: "/deploys" },
  ...
  return (
    <aside className="w-64 bg-[#081120] border-r border-zinc-800 min-h-screen p-5">
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-green-400">WebOps</h1>
        <p className="text-zinc-500 text-sm">Deploy Hub</p>
      </div>
